...
spring:
  datasource:
    username: root
    password: 123456
    url: jdbc:mysql://192.168.43.127:3307/jdbc?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=UTF-8&useSSL=true
    driver-class-name: com.mysql.cj.jdbc.Driver
    # spring2.0及以上必须要加initialization-mode: always;否则不能生效
...
@JsonIgnoreProperties({"handler","hibernateLazyInitializer"})//如果出现json报错，在实体类上加这个
public class User {
